...
import { repaymentReceiptService } from '../../receipt/services/repaymentReceiptService';
import { repaymentSecurityService } from '../../security/services/repaymentSecurityService';
import { RepaymentSecurityDetailResponse } from '../../security/dtos/repayment-security.dto';
            ...
            <div className="text-[11px] font-medium space-y-2 text-slate-600">
              ...
              <div className="flex justify-between border-b-2 pb-4">
                ...
                {schedule.invoiceNumber ? (
                  resolveS3Url(schedule.invoiceDocumentUrl) ? (
                    <a href={resolveS3Url(schedule.invoiceDocumentUrl)!}
                      target="_blank"
                      rel="noopener noreferrer"
                      title="Lihat Dokumen Invoice"
                      className="text-blue-600 font-semibold hover:text-blue-800 hover:underline underline-offset-2 decoration-blue-300"
                    >
                      {schedule.invoiceNumber}
                    </a>
                  ) : (
