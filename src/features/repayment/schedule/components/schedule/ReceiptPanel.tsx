...
import { RepaymentReceiptDetailResponse } from '../../../receipt/dtos/repayment-receipt.dto';
import RepaymentReceiptCreateWrapper from '../../../receipt/components/form/RepaymentReceiptCreateWrapper';
import RepaymentReceiptEditWrapper from '../../../receipt/components/form/RepaymentReceiptEditWrapper';
import { formatRupiah } from '../../../../../utils/currency';
import { formatDate } from '../../../../../utils/date';
import ReceiptStatusBadge from '../../../receipt/components/badges/ReceiptStatusBadge';
import { toSafeBig } from '../../../../../utils/number';
import { Big } from 'big.js';
import { InvoiceRemainingBalanceResponse } from '../../dtos/repayment-schedule.dto';
import { ReceiptStatus } from '../../../receipt/types/repayment-receipt.enum';
      ...
      <div className="overflow-x-auto mx-2 px-2">
        <table className="w-full text-left border-collapse whitespace-nowrap">
          ...
          <tbody className="text-[11px] font-medium text-slate-700 divide-y divide-slate-100">
            {receipts.length === 0 ? (
              <tr>
                <td colSpan={9} className="py-4 px-3 text-center text-slate-500 italic">
                    ...
                    >
                      ...
                      <td className="py-2 px-2 align-top text-center">
                          <div className="mt-0.5 flex justify-center">
                            <a 
                              href={resolveS3Url(rcpt.receiptDocumentUrl as string) ?? '#'} 
            ...
            {receipts.length > 0 && (
              <>
                  <tr className="bg-slate-50/50 border-t border-slate-200 font-bold">
                      <td colSpan={5} className="py-3 px-2 text-right text-slate-700 text-sm uppercase">
                        Total Pembayaran Diterima
                      </td>
                      <td className="py-3 px-2 text-right font-mono text-slate-700 text-sm">
                      {formatRupiah(
                        receipts
