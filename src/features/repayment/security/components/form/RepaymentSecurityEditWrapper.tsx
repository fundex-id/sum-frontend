      ...
      try {
        ...
        if (response.data && response.data.item) {
          ...
          const currentData: RepaymentSecurityFormRequest = {
            ...
            securityContract: repaymentSecurityRes?.securityContract || '',
            securityName: repaymentSecurityRes?.securityName || '',
            securityCode: repaymentSecurityRes?.securityCode || '',
            securitySeries: repaymentSecurityRes?.securitySeries || null,
            securityPhase: repaymentSecurityRes?.securityPhase || null,
            securitySequence: repaymentSecurityRes?.securitySequence || null,

            investeeAddress: repaymentSecurityRes?.investeeAddress || null,
            investeeTelephone: repaymentSecurityRes?.investeeTelephone || null,
            investeePostalCode: repaymentSecurityRes?.investeePostalCode || null,
